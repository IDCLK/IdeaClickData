...
<html>
<head>
<script type="text/javascript" src="<%= themeDisplay.getPathJavaScript() %>/js/validate.js"></script>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Login page</title>

</head>
    <body>
       <form name="myform" action="${addNameUrl}" onsubmit="return validateForm()" method="post">
            <center>
